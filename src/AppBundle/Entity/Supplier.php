...
class Supplier
{
     ...
     * @ORM\OneToOne(targetEntity="SupplierPhoto", cascade={"persist", "remove"})
     * @ORM\JoinColumn(name="Supplier_photo_id", referencedColumnName="id")
     */
    private $photo;
    ...
    /**
     * @ORM\OneToMany(targetEntity="PurchaseOrderHeader", mappedBy="supplier")
     */
